					...
					<div className='contact-box'>
						<motion.div
							...
							<div className='contact-heading'>
								<p>
									Looking for a seasoned Software Engineer to lead your next big project? I specialize in building high-performance web experiences. Reach out for collaborations, consulting, or just to say hello.
								</p>
							</div>
							<div className='contact-hello'>
								...
								<a
									...
									href="https://www.linkedin.com/in/namdo2465/"
									target="_blank"
									rel="noreferrer"
									>
									linkedin.com/in/namdo2465
								</a>
								<a
									className='hello-links'
